...
\section{TECHNOLOGY \\ SKILLS}
    ...
    {\sl Software Engineering:} Git, Maven, GNU Make, GCC, MinGW \\
    {\sl Misc. Technologies:} bash, ssh, LaTeX, PostgreSQL, VirtualBox, Vim \\
    {\sl Operating Systems:} Debian, Ubuntu, Arch Linux, Windows XP -- Windows 8.1
...
\section{PROJECTS}
    ...
    \begin{itemize} \itemsep -2pt
        ...
        \item Implemented read/write on file descriptors by setting up shared memory and performing I/O asychronously through low-level functions.
